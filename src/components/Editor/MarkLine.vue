        ...
        showLine(isDownward, isRightward) {
            ...
            components.forEach(component => {
                ...
                const conditions = {
                    top: [
                        {
                            isNearly: this.isNearly(curComponentStyle.top, top), // xt与top比
                            lineNode: lines.xt[0], // xt
                            line: 'xt',
                            dragShift: top, // 吸附效果,拖拽节点top应该变为的值
                            lineShift: top, // 线的top值
                        },
                        {
                            isNearly: this.isNearly(curComponentStyle.bottom, top), //xt与bottom比
                            lineNode: lines.xt[0], // xt
                            line: 'xt',
                        ...
                        {
                            // 组件中间与拖拽节点的中间是否对齐
                            isNearly: this.isNearly(curComponentStyle.top + curComponentHalfHeight, top + componentHalfHeight), // xc与中间比
                        ...
                        {
                            isNearly: this.isNearly(curComponentStyle.top, bottom), //xb与top比
                        ...
                        {
                            isNearly: this.isNearly(curComponentStyle.bottom, bottom), //xb与bottom比
                            lineNode: lines.xb[0], // xb
                            line: 'xb',
                    ...
                    left: [
                        {
                            ...
                            line: 'yl',
                            dragShift: left, // 吸附效果,拖拽节点left应该变为的值
                            lineShift: left, // 线的left值
                        },
                        {
